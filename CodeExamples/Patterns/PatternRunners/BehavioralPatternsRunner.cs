...
{
    class BehavioralPatternsRunner
    {
        public static void Run()
        {
            ...
            contextState.Request1();
            contextState.Request2();
            ...
            ContextInterpreter contextInterpreter = new ContextInterpreter(roman);
            ...
            {
                exp.Interpret(contextInterpreter);
            }
